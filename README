...
It has been tested over **AVR ATmega, ESP8266 and ESP62, and STM32** micro controllers family, using serial communication port, but it can be ported to other environment.  
